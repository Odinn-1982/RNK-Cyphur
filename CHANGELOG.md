...
### Added
- **Internationalization**: Added support for 16 new languages, bringing the total to 41 supported languages.
  - Added: Catalan, Greek, Romanian, Slovak, Serbian, Croatian, Bulgarian, Indonesian, Malay, Hindi, Bengali, Persian, Tagalog, Lithuanian, Latvian, Estonian.
